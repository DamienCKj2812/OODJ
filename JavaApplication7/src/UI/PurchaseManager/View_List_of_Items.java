 ...
 * @author zhuow
 */
public class View_List_of_Items extends javax.swing.JFrame {

    /**
     * Creates new form PurchaseOrder
     */
    public View_List_of_Items() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        View_list_of_items_Table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Code", "Item Name", "Supplier ID", "Stock Level", "Reorder Level", "Price per Unit", "Category"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_List_of_Items.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new View_List_of_Items().setVisible(true);
            }
        });
    }
