 ...
 * @author zhuow
 */
public class View_List_of_PurchaseOrder extends javax.swing.JFrame {

    /**
     * Creates new form PurchaseOrder
     */
    public View_List_of_PurchaseOrder() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        View_list_of_PurchaseOrder_Table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PO Number", "Requisition ID", "Item Code", "Item Name", "Quantity", "Supplier ID", "Order Date", "Expected Delivery Date", "Status", "Total Cost", "Purchase Manager ID", "Remarks"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_List_of_PurchaseOrder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
